...
export function ChoiceCard() {
  ...
  return (
    <div
      className="pointer-events-none absolute inset-x-0 z-30 flex justify-center px-3 safe-offset-bottom safe-x sm:[--safe-bottom-base:11rem] [--safe-bottom-base:8rem]"
    >
